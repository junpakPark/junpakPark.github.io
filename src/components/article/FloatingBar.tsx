...
const ButtonsCollection: React.FC = () => {
    ...
    return (
        <div className="flex gap-x-8">
            <button onClick={scrollToTop} className="w-8 h-8 inline-flex justify-center items-center gap-x-2 rounded-full border border-transparent text-gray-400 hover:text-gray-700 hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none">
            ...
            <button onClick={copyCurrentUrl} className="w-8 h-8 inline-flex justify-center items-center gap-x-2 rounded-full border border-transparent text-gray-400 hover:text-gray-700 hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none">
                <svg className="flex-shrink-0 w-4 h-4" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <button onClick={scrollToBottom} className="w-8 h-8 inline-flex justify-center items-center gap-x-2 rounded-full border border-transparent text-gray-400 hover:text-gray-700 hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none">
                <svg className="flex-shrink-0 w-4 h-4" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" xmlns="http://www.w3.org/2000/svg">
...
const FloatingBar: React.FC<HeadingProps> = ({ headings }) => {
    return (
        <div className="fixed top-[1rem] py-[16rem] bottom-0 right-[max(0px,calc(50%-45rem))] w-[19.5rem] overflow-y-auto hidden xl:block">
