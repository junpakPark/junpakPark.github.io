                        ...
                        {headings.map(heading => (
                            ...
                            >
                                <a
                                    ...
                                    className="block py-0.5 text-sm font-medium leading-6 text-slate-700 hover:text-slate-900 focus:outline-none focus:text-blue-600 dark:text-slate-400 dark:hover:text-slate-300 dark:focus:text-blue-500 hs-scrollspy-active:text-blue-600 dark:hs-scrollspy-active:text-blue-400"
                                >
                                    {heading.text}
                                </a>
                            </li>
...
const FloatingBar: React.FC<HeadingProps> = ({ headings }) => {
    return (
        <div className="sticky top-[240rem] space-y-2.5 font-sans mt-[4rem] px-2 text-sm col-span-2 col-start-10">
